...
const string strMessageMagic = "Xuro Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    int64_t nSubsidy = 0 * COIN;
			...
			else if(pindexBest->nHeight < 100)
		{
			...
			else if(pindexBest->nHeight < 5200)
		{
			nSubsidy = 95 * COIN;
		}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Xuro", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "08/17/2014 Xuro Launched!";
        CTransaction txNew;
        txNew.nTime = 1408247036;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1408247036;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2412081;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xed71d22718c206da7c4ca01c88c8a133f2a9ecdaf99b3f49823802691774468a"));
        block.print();
